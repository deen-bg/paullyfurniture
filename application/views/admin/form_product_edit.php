...
<head>
	...
	<title>Edit Product | Paully Furniture </title>
                              ...
                              <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" 
								...
								<div class="form-group form-material">
									...
									<select class="form-control" name="type" required>
										...
										<?php foreach ($categories as $val_t) : ?>
										<option value="<?=$val_t['id']; ?>" <?php if($prod_descs[0]['type_id'] == $val_t['id']){ echo 'selected'; } ?>><?=$val_t['name']; ?></option>
										<?php endforeach ?>
									</select>
								</div>
                                <div class="form-group form-material" data-plugin="formMaterial">
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									<label class="form-control-label" for="image">อัลบั้ม</label>
